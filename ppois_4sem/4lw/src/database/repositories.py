...
class StationRepository(IStationRepository):
    ...
    def _add_station(self, name: str, line: str) -> bool:
    ...
    def _get_station(self, station_id: int) -> Optional[Dict]:
    ...
    def _update_station(self, station_id: int, name: Optional[str] = None, line: Optional[str] = None) -> bool:
    ...
    def _delete_station(self, station_id: int) -> bool:
